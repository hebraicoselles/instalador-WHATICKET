...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Canal SN Tec que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Canal SN Tec, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Canal SN Tec\n"
  printf "   [1] Atualizar Canal SN TecP\n"
  printf "   [2] Deletar Canal SN Tec\n"
  printf "   [3] Bloquear Canal SN TecP\n"
  printf "   [4] Desbloquear Canal SN Tec\n"
  printf "   [5] Alter. dominio Canal SN Tec\n"
  printf "\n"
  read -p "> " option
